...
Item {
    id: rightBar
    // Sized by parent Layout in Bar.qml; keep implicit size as fallback
    ...
    //  CONTENT ROW --- pack to the right when the section is wider than content
    RowLayout {
        anchors.fill: parent
        ...
        // Leading flex so zones sit on the right edge of this section
        ...
        ColumnLayout {
            ...
            Text {
                id: ramValue
                Layout.alignment: Qt.AlignHCenter
                Layout.maximumWidth: Tokens.usageBarWidth * 3
