...
# Lives under doomshell/utils/scripts; cava config at doomshell/assets/cava/config
set -uo pipefail
...
[[ -f "$CAVA_CONF" ]] || CAVA_CONF="${HOME}/.config/quickshell/doomshell/assets/cava/config"
[[ -f "$CAVA_CONF" ]] || CAVA_CONF="${HOME}/Doomslayer-mod/.config/quickshell/doomshell/assets/cava/config"
