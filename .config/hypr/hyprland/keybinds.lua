...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightness increment || brightnessctl s 5%+"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightness decrement || brightnessctl s 5%-"),
    { locked = true, repeating = true })
